...
class AppConfig(BaseSettings):
    ...
    POSTGRES_USER: str = "codebase_rag"
    POSTGRES_PASSWORD: str = "codebase_rag"
    POSTGRES_DB: str = "codebase_rag"

    # Provider-specific settings for orchestrator
    ORCHESTRATOR_PROVIDER: str = ""
    ORCHESTRATOR_MODEL: str = ""
    ORCHESTRATOR_API_KEY: str | None = None
    ORCHESTRATOR_API_VERSION: str | None = None
    ...
    CYPHER_API_VERSION: str | None = None
    ...
    def _get_default_config(self, role: str) -> ModelConfig:
        ...
        if provider and model:
            return ModelConfig(
                ...
                model_id=model,
                api_version=getattr(self, f"{role_upper}_API_VERSION", None),
